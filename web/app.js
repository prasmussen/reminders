...
var _user$project$App_Model$validateDraft = function (draft) {
	var _p0 = draft.staleStartDate;
	if (_p0 === true) {
		return _elm_lang$core$Result$Err('Reminder must be in the future');
	} else {
		return _elm_lang$core$Result$Ok(draft);
	}
};
var _user$project$App_Model$initModel = {query: '', user: _krisajenkins$remotedata$RemoteData$NotAsked, reminders: _krisajenkins$remotedata$RemoteData$NotAsked, draft: _elm_lang$core$Maybe$Nothing, createReminderError: _elm_lang$core$Maybe$Nothing, showRelativeDate: true, showRightMenuOnMobile: false};
var _user$project$App_Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {query: a, user: b, reminders: c, draft: d, createReminderError: e, showRelativeDate: f, showRightMenuOnMobile: g};
	});
var _user$project$App_Model$User = function (a) {
	return {email: a};
};
var _user$project$App_Model$Draft = F6(
	function (a, b, c, d, e, f) {
		return {title: a, startDate: b, endDate: c, start: d, end: e, staleStartDate: f};
	});
var _user$project$App_Model$Reminder = F5(
	function (a, b, c, d, e) {
												...
												function (start) {
													return A2(
														...
														function (end) {
															return A2(
																_elm_lang$core$Json_Decode$andThen,
																function (staleStartDate) {
																	return _elm_lang$core$Json_Decode$succeed(
																		{title: title, startDate: startDate, endDate: endDate, start: start, end: end, staleStartDate: staleStartDate});
																},
																A2(_elm_lang$core$Json_Decode$field, 'staleStartDate', _elm_lang$core$Json_Decode$bool));
														},
...
var _user$project$App_Port$listRemindersSuccess = _elm_lang$core$Native_Platform.incomingPort(
	...
	_elm_lang$core$Json_Decode$list(
		A2(
									...
									function (start) {
										return A2(
											...
											function (startRelative) {
												return _elm_lang$core$Json_Decode$succeed(
													{title: title, link: link, startDate: startDate, start: start, startRelative: startRelative});
											},
											A2(_elm_lang$core$Json_Decode$field, 'startRelative', _elm_lang$core$Json_Decode$string));
									},
									A2(_elm_lang$core$Json_Decode$field, 'start', _elm_lang$core$Json_Decode$string));
							},
							A2(_elm_lang$core$Json_Decode$field, 'startDate', _elm_lang$core$Json_Decode$string));
			...
			A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string))));
var _user$project$App_Port$listRemindersFailed = _elm_lang$core$Native_Platform.incomingPort('listRemindersFailed', _elm_lang$core$Json_Decode$string);
var _user$project$App_Port$createReminderSuccess = _elm_lang$core$Native_Platform.incomingPort(
...
var _user$project$App_Port$createReminder = _elm_lang$core$Native_Platform.outgoingPort(
	'createReminder',
	function (v) {
		return {title: v.title, startDate: v.startDate, endDate: v.endDate, start: v.start, end: v.end, staleStartDate: v.staleStartDate};
	});
		...
		switch (_p0.ctor) {
				...
				if (_p2.ctor === 'Just') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								user: _krisajenkins$remotedata$RemoteData$Success(_p3),
								reminders: _krisajenkins$remotedata$RemoteData$Loading
							}),
						{
							ctor: '::',
							_0: _user$project$App_Port$listReminders(true),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
			...
			case 'ListRemindersSuccess':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							reminders: _krisajenkins$remotedata$RemoteData$Success(_p0._0)
						}),
					{ctor: '[]'});
			case 'ListRemindersFailed':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							reminders: _krisajenkins$remotedata$RemoteData$Failure(_p0._0)
						}),
					{ctor: '[]'});
			case 'SetDraft':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{draft: _p0._0, createReminderError: _elm_lang$core$Maybe$Nothing}),
					{ctor: '[]'});
			case 'ToggleRelativeDate':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ToggleRightMenuOnMobile':
				return A2(
					...
					{ctor: '[]'});
			case 'CreateReminder':
				var _p4 = A2(_elm_lang$core$Maybe$map, _user$project$App_Model$validateDraft, model.draft);
				if ((_p4.ctor === 'Just') && (_p4._0.ctor === 'Ok')) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{
							ctor: '::',
							_0: _user$project$App_Port$createReminder(_p4._0._0),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
			...
			case 'CreateReminderFailed':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							createReminderError: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					{ctor: '[]'});
			case 'ResetCreateReminderError':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{createReminderError: _elm_lang$core$Maybe$Nothing}),
					{ctor: '[]'});
			default:
				var _p7 = model.user;
...
var _user$project$App_Update$ResetCreateReminderError = {ctor: 'ResetCreateReminderError'};
var _user$project$App_Update$CreateReminderFailed = function (a) {
	return {ctor: 'CreateReminderFailed', _0: a};
};
...
var _user$project$App_Update$ListRemindersFailed = function (a) {
	return {ctor: 'ListRemindersFailed', _0: a};
};
	...
	switch (_p0.ctor) {
		...
		case 'Loading':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Loading reminders...'),
					_1: {ctor: '[]'}
				});
		case 'Failure':
			return A2(
		...
		default:
			if (_p0._0.ctor === '[]') {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('No upcoming reminders'),
						_1: {ctor: '[]'}
					});
			} else {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href(reminder.link),
											_1: {
												ctor: '::',
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(reminder.title),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('reminders'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$App_View$renderDraftOrCreateError = F2(
	function (draft, createError) {
		var _p1 = createError;
		if (_p1.ctor === 'Just') {
			return A2(
				_elm_lang$html$Html$div,
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Update$ResetCreateReminderError),
									_1: {ctor: '[]'}
								}
							}
						},
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Failed to create reminder: ', _p1._0)),
						_1: {ctor: '[]'}
					}
				});
		} else {
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(draft.title),
									_1: {
										ctor: '::',
										_0: A2(
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(draft.start),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Update$CreateReminder),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$App_View$renderCompose = function (model) {
	var _p2 = A2(_elm_lang$core$Maybe$map, _user$project$App_Model$validateDraft, model.draft);
	if (_p2.ctor === 'Just') {
		if (_p2._0.ctor === 'Ok') {
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						},
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$App_View$renderDraftOrCreateError, _p2._0._0, model.createReminderError),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('This web app is 100% client side and the source is available on '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$a,
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'Sign out (',
								A2(_elm_lang$core$Basics_ops['++'], _p5._0._0.email, ')'))),
						_1: {ctor: '[]'}
					});
			} else {
				return A2(
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Reminders'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _user$project$App_View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$App_View$renderNav(model),
			_1: {
				ctor: '::',
				_0: _user$project$App_View$renderContent(model),
				_1: {ctor: '[]'}
			}
		});
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$App_Port$listRemindersFailed(_user$project$App_Update$ListRemindersFailed),
						_1: {
							ctor: '::',
